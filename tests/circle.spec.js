...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(parseFloat(Object.values(circle(3))[2].toPrecision(4))).toEqual(18.84);
    expect(parseFloat(Object.values(circle(3))[0].toPrecision(4))).toEqual(3);

    // ESCREVA SEUS TESTES ABAIXO: OBS TEM COMO EU FIZ A ULTIMA PARTE
    ...
    // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3, OU INVES DE FAZER ISSO EU BUSQUEI VALOR POR VALOR DO OBJETO NAS LINHAS 38,39,40.
  });
});
